(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_6ec76bef._.js", {
...
const TaskSubmissionForm = ({ onSubmit })=>{
    _s();
...
_s(TaskSubmissionForm, "woqMTX6igxsX6/9vX4dQZlxR7yY=", false, function() {
    return [
...
function Home() {
    ...
    const handleTaskSubmit = (newTaskName)=>{
        setTasks((prevTasks)=>[
                ...prevTasks,
                newTaskName
            ]);
        toast({
            ...
            description: `Task "${newTaskName}" has been submitted.`
        });
    };
...
_s(Home, "RO0Dd0yFV7NoT2LGMoLeXvG1tOg=", false, function() {
    return [
...
//# sourceMappingURL=src_6ec76bef._.js.map